...
PROGNOSIS_MAP = {'Fungal infection':0,'Allergy':1,'GERD':2,'Chronic cholestasis':3,'Drug Reaction':4,
...
te.columns = new_col
te['Prognosis'] = pd.to_numeric(te['Prognosis'].replace(PROGNOSIS_MAP), errors='raise')


X_test= te[l1]
y_test = te["Prognosis"].astype(int)
